...
* [Infrastructure Overview](../../infrastructure/data-infra/guide-to-the-runtime-environment.md)
...
* [Google BigQuery](https://cloud.google.com/bigquery/), a managed data warehouse we use to allow the rest of Nubank to easily analyze our data.
* [Looker](https://looker.com/), a dashboard/visualization/BI front-end for BigQuery.
...
[See here](../../infrastructure/data-infra/guide-to-the-runtime-environment.md#aurora-overview)
...
* Command line utility for interacting with data infra ([sample commands](/on-call/data-infra/tools/cli_examples.md))
...
* See: [Monitoring the Nightly Run](../../on-call/data-infra/monitoring_nightly_run.md)
...
* [common-etl-spec](https://github.com/nubank/common-etl-spec) - Repository of clojure specs shared across ETL-related services
  ...
  * [curva-de-rio](https://github.com/nubank/curva-de-rio) - ETL ingestor for non-Datomic data
...
Moved to <https://github.com/nubank/data-infra-docs/blob/master/onboarding/data-infra/introduction.md#getting-accounts-and-permissions>
